...
function build_container() {
  ...
  if [ -z $GO_PIPELINE_LABEL ]; then
      ...
      docker build -t ubirch/ubirch-notary-service:v$GO_PIPELINE_LABEL .
  else
      # build with GoCD
      docker build -t ubirch/ubirch-notary-service:v$GO_PIPELINE_LABEL --build-arg GO_PIPELINE_NAME=$GO_PIPELINE_NAME \
  ...
  # push Docker image
  docker push ubirch/ubirch-notary-service
  docker push ubirch/ubirch-notary-service:v$GO_PIPELINE_LABEL
  if [ $? -ne 0 ]; then
...
function container_tag () {
    docker pull ubirch/ubirch-notary-service:v$GO_PIPELINE_LABEL
    docker tag ubirch/ubirch-notary-service:v$GO_PIPELINE_LABEL ubirch/ubirch-notary-service:latest
    docker push ubirch/ubirch-notary-service:latest
